...
export default function UpdateReward() {
        ...
        async function getRewardById(){
            ...
            .catch(error => {
                alert("Unable to read the product detail!")
            })
        }

        //useEffect(getRewardById, [])
        useEffect(() => {
            getRewardById();
          }, []);

        function getIndexImage(Name)
        {
            for (let i=0; i<options_icons.length; i++)
            {
                if (options_icons[i].label==Name)
                    return i;
    ...
    async function handleSubmitUpdate(event)
    {
        ...
        try {
            ...
            else if (response.status === 400)
            {
                ...
                alert("Unable to update the reward")
            }
        } catch (error) {
            ...
            <div className="row">
                <div className="col-md-8 mx-auto rounded border p-4 " style={{backgroundColor: '#73AB84'}} >
                    ...
                    <div className="row mb-3" >
                        <label className="col-sm-4 col-form-label" style={{fontSize:'20px'}}>ID</label>
                        <div className="col-sm-8">
                            <input readOnly className="form-control-plaintext" name="reward_name" id='frm' defaultValue={params.id} style={{backgroundColor: '#AEE1E5'}}/>
                        </div>
                    </div>

                    {
                        ...
                        <form onSubmit={handleSubmitUpdate}>
                            <div className="row mb-3" >
                                ...
                                <div className="col-sm-8">
                                    <input className="form-control" name="reward_name" defaultValue={initialData.name} id='frm' style={{backgroundColor: '#AEE1E5'}}/>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8">
                                    <textarea className="form-control" name="reward_description" defaultValue={initialData.description} rows="4" style={{backgroundColor: '#AEE1E5'}}/>
                                    <span className="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8" >
                                    <ReactSelect
                                        ...
                                        defaultValue={options_icons[getIndexImage(initialData.image)]}
                                    />
                                    <span className="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8">
                                    <input className="form-control" name="reward_cost" defaultValue={initialData.cost} style={{backgroundColor: '#AEE1E5'}}/>
                                    <span className="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8">
                                    ...
                                    <input type = "checkbox" checked = {instantBuyChecked} defaultValue={Boolean(initialData.instantBuy)} onChange={handleChangeCheckBox} style = {{marginRight: 20, transform: 'scale(2)' }}/>
                                    <span className="text-danger"></span>
                            ...
                            <div className="row mb-3" >
                                ...
                                <div className="col-sm-8">
                                    <input className="form-control" name="reward_roomId" defaultValue={initialData.roomId} id='frm' style={{backgroundColor: '#AEE1E5'}} />
                                    <span className="text-danger"></span>
                                </div>
                            </div>
